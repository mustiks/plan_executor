  ...
  module Tests
    class ResourceTest < BaseSuite
      ...
      test 'X010', 'Create New' do
        ...
        ignore_client_exception { @temp_resource = ResourceGenerator.generate(@resource_class,1).create }
      ...
      test 'X012', 'Conditional Create (No Matches)' do
        ...
        ignore_client_exception { @conditional_create_resource_a = ResourceGenerator.generate(@resource_class,1).conditional_create(ifNoneExist) }
      ...
      test 'X013', 'Conditional Create (One Match)' do
        ...
        ignore_client_exception { @conditional_create_resource_b = ResourceGenerator.generate(@resource_class,1).conditional_create(ifNoneExist) }
      ...
      test 'X014', 'Conditional Create (Multiple Matches)' do
        ...
        ignore_client_exception { @conditional_create_resource_c = ResourceGenerator.generate(@resource_class,1).conditional_create(ifNoneExist) }
      ...
      test 'X030', 'Update Existing' do
        ...
        if @preexisting.nil?
          ...
          ResourceGenerator.set_fields!(@preexisting, version_namespace.to_s, 1)
      ...
      test 'X032', 'Conditional Update (No Matches)' do
        ...
        ignore_client_exception { @conditional_update_resource_a = ResourceGenerator.generate(@resource_class,1).conditional_update(searchParams) }
        # chances are good that no resource has this ID
      ...
      test 'X034', 'Conditional Update (Multiple Matches)' do
        ...
        ignore_client_exception { @conditional_update_resource_b = ResourceGenerator.generate(@resource_class,1).conditional_update(searchParams) }
      ...
      test 'X060', 'Validate' do
        ...
        tres = ResourceGenerator.generate(@resource_class,1)
